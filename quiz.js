// JavaScript file for  "Квиз - Blockchain технологијa"
var score = 0; //Promenjiva za poene
var questionN = 0; //Promenjiva za redni broj pitanja 
var obj = []; //Niz u kome će biti 10 random pitanja iz .json fajla
var clickedButton = false; //Pomoćna promenjiva za setovanje tajmera
...
fetch("./questions.json").then(function(resp) { //ucitavanje iz .json fajla
    ...
    .then(function(questions) {
        //Nasumično uzimanje 10 pitanja iz promenjive u koju je učitan "JSON" i
...
$(document).ready(function() {
    $("#next").click(function() {
        ...
        if (name != "") {
            ...
            $("#globe_smiley").hide();
            $("#next").hide();
            document.getElementById("welcome").innerHTML = $("#name").val() + ", добродошли у квиз који ће тестирати Ваше знање о Blockchain технологији Упознајте се са правилима и започните квиз.<br><b>Срећно!</b>"
            $("#welcome").fadeIn();
            $("#start").fadeIn();
            $("#resultTable").fadeIn();
            $(".rules").fadeIn();
...
//funkcija za učitavanje narednog pitanja
...
//ponđeni odgovori ako je tačan izabran odgovor dugme poszane zelene bole
